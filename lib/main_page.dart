...
class _navbarState extends State<navbar> {
  ...
  final List<Widget> _screens = const [
    ...
    Center(child: Text("Chats", style: TextStyle(color: Colors.white))),
    Center(child: Text("Sell", style: TextStyle(color: Colors.white))),
    Center(child: Text("My Ads", style: TextStyle(color: Colors.white))),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PersistentTabView(backgroundColor: Colors.black,
